...
- Relicense program code from **GPL-3.0** to **AGPL-3.0** (GNU Affero General Public License v3). Root [LICENSE](LICENSE) now contains the official AGPL-3.0 text; `serve.py` header and docs updated accordingly.
